...
<ol><li><strong>Driver of Behaviour:</strong> Understand stakeholder needs, get behind data and reveal fresh attitudes and behaviours. Provide some future direction and longevity<br>
<ol><li><strong>Competitive Advantage:</strong> Reveal new ideas, words, segments, services and offerings that link with a deeper brand promise, creating fresh competitive advantage<br>
<ol><li><strong>Immediately Actionable:</strong> The insight must drive the organization. Even if it requires new indications, lifecycle management options, etc., you should start planning now</ol></li></p>
...
<ul><li>Higher accuracy: Webb et al. (2016) found solutions accompanied by insight are actually more likely to be correct (r=0.40-0.50) than analytically derived solutions</ul></li></p>
