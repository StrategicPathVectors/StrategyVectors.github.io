...
<ol><li><strong>Previously Unknown:</strong> If you knew it already, then so did your competitor—that is data or fact. An insight provides a unique viewpoint, preferably with longevity<br>
<ol><strong>Driver of Behaviour:</strong> Understand stakeholder needs, get behind data and reveal fresh attitudes and behaviours. Provide some future direction and longevity<br>
<ol><strong>Competitive Advantage:</strong> Reveal new ideas, words, segments, services and offerings that link with a deeper brand promise, creating fresh competitive advantage<br>
<ol><strong>Immediately Actionable:</strong> The insight must drive the organization. Even if it requires new indications, lifecycle management options, etc., you should start planning now</ol></p>
...
<ul>Suddenness: They arrive all-at-once, not through stepwise progress (the rigour of process gets you far; but isn’t everything!)<br>
<ul>No intermediate states: You don't get "partway" to an insight<br>
<ul>Positive affect: The characteristic "Aha!" feeling accompanies breakthrough understanding that can then lead to real momentum across the room!<br>
<ul>Higher accuracy: Webb et al. (2016) found solutions accompanied by insight are actually more likely to be correct (r=0.40-0.50) than analytically derived solutions</ul></p>
